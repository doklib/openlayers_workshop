...
function init(){
  ...
  const openstreetVectorTileStyles = 'https://api.maptiler.com/maps/9bb062f5-fb4f-4025-9031-db9e2e8b6ecd/style.json?key=Cw0pA7B7B54FjKGg2cc4';
  //olms.apply(map, openstreetVectorTileStyles);

  fetch(openstreetVectorTileStyles).then(function(response) {
